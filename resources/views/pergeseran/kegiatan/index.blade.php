...
<section class="content">
    <div class="row">
        <div class="col-md-3">
            @include('pergeseran.kegiatan.deskripsi')
        </div>
        ...
        <div class="col-md-9">
            <div class="box box-primary">
                <div class="box-header">
                  ...
                  <div class="box-tools">
                    <a href="/bidang/pergeseran/program" class="btn btn-sm bg-gray btn-flat"><i class="fa fa-arrow-left"></i> Kembali</a>
                ...
                <div class="box-body table-responsive no-padding text-sm">
                  <table class="table table-hover">
                    ...
                    <tr>
                        ...
                        <td>{{$item->nama}}</td>
                        <td>
                            <a href="/bidang/pergeseran/program/kegiatan/{{$program->id}}/sub/{{$item->id}}"
