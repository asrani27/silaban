...
<section class="content">
    <div class="row">
        <div class="col-md-3">
            @include('pergeseran.uraian.deskripsi')
        </div>
        ...
        <div class="col-md-9">
            <div class="box box-primary">
                ...
                <form class="form-horizontal" action="/bidang/pergeseran/program/kegiatan/{{$program->id}}/sub/{{$kegiatan->id}}/uraian/{{$subkegiatan->id}}/add" method="post">
                    @csrf
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        ...
                        <a href="/bidang/pergeseran/program/kegiatan/{{$program->id}}/sub/{{$kegiatan->id}}/uraian/{{$subkegiatan->id}}" class="btn bg-gray btn-flat btn-block"><i class="fa fa-arrow-left"></i> Kembali</a>
                      </div>
                    </div>
                  </div>
                </form>
