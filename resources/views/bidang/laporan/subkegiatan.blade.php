        ...
        <div class="box">
          ...
          <div class="box-body">
            @foreach ($data as $item)
                <a href="/bidang/laporanrfk/{{$tahun}}/{{$bulan}}/{{$program->id}}/{{$kegiatan->id}}/{{$item->id}}" class="btn btn-primary btn-block btn-sm btn-flat"><strong>{{$item->nama}}</strong></a>                
            @endforeach
            <a href="/bidang/laporanrfk/{{$tahun}}/{{$bulan}}/{{$program->id}}" class="btn bg-purple btn-block btn-sm btn-flat"><strong>Kembali</strong></a>   
          </div>
        </div>
      </div>
    </div>
