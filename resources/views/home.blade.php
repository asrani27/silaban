...
<head>
  ...
  <style>
    body {
	background: linear-gradient(-45deg, #ee7752, #37517e, #23a6d5, #23d5ab);
  ...
  <header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          <li><a class="getstarted scrollto" href="/login"><i class="bi bi-lock"></i> &nbsp;&nbsp; Login</a></li>
        </ul>
    ...
    <section id="why-us" class="why-us section-bg">
      <div class="container-fluid" data-aos="fade-up">
        ...
        <div class="row">
          ...
          <div class="col-lg-5 align-items-stretch order-1 order-lg-2 img" style='background-image: url("/theme/assets/img/why-us.png");' data-aos="zoom-in" data-aos-delay="150">&nbsp;</div>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 footer-links">
            ...
            <div class="social-links mt-3">
              ...
              <a href="https://www.instagram.com/uptdlablingbjm/" target="_blank" class="instagram"><i class="bx bxl-instagram"></i></a>
