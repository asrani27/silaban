    ...
    <div class="col-md-12">
        <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title"><i class="fa fa-list"></i> Edit PPTK</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="/admin/pptk/edit/{{$data->id}}" method="post">
                @csrf
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="nip_pptk" placeholder="NIP PPTK" value="{{$data->nip_pptk}}" class="form-control" required>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="nama_pptk" placeholder="Nama PPTK" value="{{$data->nama_pptk}}" class="form-control" required>
                  </div>
                </div>
