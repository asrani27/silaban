...
<section class="content">
    <div class="row">
        <div class="col-md-3">
            @include('perubahan.subkegiatan.deskripsi')
        </div>
            ...
            <div class="box box-primary">
                <div class="box-header">
                  ...
                  <div class="box-tools">
                    ...
                    <a href="/bidang/perubahan/program/kegiatan/{{$program->id}}/sub/{{$kegiatan->id}}/add" class="btn btn-sm btn-primary btn-flat "><i class="fa fa-plus-circle"></i> Tambah Sub Kegiatan</a>
                  </div>
                </div>
                <!-- /.box-header -->
                    ...
                    <tr>
                        ...
                        <td width="15%">
                          @if ($item->kirim_angkas == null)
                            <a href="/bidang/perubahan/program/kegiatan/{{$program_id}}/sub/{{$kegiatan_id}}/edit/{{$item->id}}"
                                class="btn btn-xs btn-flat btn-success"><i class="fa fa-edit"></i></a>
                            <a href="/bidang/perubahan/program/kegiatan/{{$program_id}}/sub/{{$kegiatan_id}}/delete/{{$item->id}}"
                        ...
                        <td>
                          @if ($item->kirim_angkas == null)
                          <a href="/bidang/perubahan/kirim_angkas/{{$item->id}}"
